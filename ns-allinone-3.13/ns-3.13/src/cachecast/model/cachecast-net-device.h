...
#ifndef CACHECAST_NET_DEVICE_H
#define CACHECAST_NET_DEVICE_H
 ...
 * propagation delay is set in the CacheCastChannel).
 */
class CacheCastNetDevice : public NetDevice
{
public:
   ...
   */
  bool Attach (Ptr<CacheCastChannel> ch);

  /**
   * Attach a queue to the CacheCastNetDevice.
   *
   * The CacheCastNetDevice "owns" a queue that implements a queueing 
  ...
  /**
   * Attach a receive ErrorModel to the CacheCastNetDevice.
   *
   * The CacheCastNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected CacheCastChannel.
   *
   * The CacheCastNetDevice receives packets from its connected channel
   * and forwards them up the protocol stack.  This is the public method
   * used by the channel to indicate that the last bit of a packet has 
   * arrived at the device.
   *
   * @see CacheCastChannel
...
private:
  ...
  CacheCastNetDevice& operator = (const CacheCastNetDevice &);
  CacheCastNetDevice (const CacheCastNetDevice &);
...
private:
  ...
  /**
   * The CacheCastChannel to which this CacheCastNetDevice has been
   * attached.
   * @see class CacheCastChannel
   */
  Ptr<CacheCastChannel> m_channel;

  /**
   * The Queue which this CacheCastNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the CacheCastNetDevice
