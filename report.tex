...
\subsection{Helpers}
The helpers are used to setup the server unit / CMU and CSU on nodes before channel between these units is defined. CacheCastHelper::Install method takes pointer for two nodes as arguments.  First, CacheCastNetDevices are created, one for each node.      

\subsubsection{CacheCastHelper}
