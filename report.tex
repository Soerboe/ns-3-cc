...
caption=HandlePacket() function in CacheCastServerUnit, frame=tb]
--------------------------------------------------
bool
...
error on first packet lost if same PID
